...
Input/Output frequency & sample rate can be configured after running ```make -f haiku.makefile config``` by adding the flags ``` make -f haiku.makefile RATE=48000.0 FRAMES=16 ```. <br>
